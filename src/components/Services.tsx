...
const Services = () => {
  ...
  return (
    <div id="services" className="scroll-mt-24 bg-black/95 py-8 px-4 sm:px-6 lg:px-8 2xl:px-12 border-t border-cream/5 shadow-inner">
      <div>
        <SplitText
            text="My services"
        ...
        <HoverExpand_002 items={items} className="w-full rounded-2xl py-2" />
      </div>
    </div>
  );
};
