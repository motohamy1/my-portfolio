...
const Folder: React.FC<FolderProps> = ({ color = '#722F37', size = 1, items = [], className = 'font-curisive font-bold text-[8px] text-center' }) => {
  const maxItems = 3;
  ...
  const paper1 = darkenColor('#722F37', 0.1);
  const paper2 = darkenColor('#722F37', 0.05);
  const paper3 = '#722F37';
