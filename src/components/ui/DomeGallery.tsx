...
const DEFAULT_ITEMS: GalleryItem[] = [
  { color: 'var(--color-card-one)', alt: 'Card One' },
  { color: 'var(--color-card-two)', alt: 'Card Two' },
  { color: 'var(--color-card-three)', alt: 'Card Three' },
  { color: 'var(--color-card-large)', alt: 'Card Large' },
  { color: 'var(--color-cream)', alt: 'Cream' },
  { color: 'var(--color-wine)', alt: 'Wine' },
  { color: 'var(--color-back)', alt: 'back' },
  { color: 'var(--color-rust)', alt: 'Rust' }
];
...
function buildItems(pool: GalleryItem[], seg: number): ItemDef[] {
  ...
  if (pool.length === 0) {
    return coords.map(c => ({ ...c, src: '', alt: '', color: '' }));
  }
  
  // No warning needed for color repetition, it's expected
  ...
  return coords.map((c, i) => ({
    ...
    src: usedItems[i].src,
    alt: usedItems[i].alt,
    color: usedItems[i].color,
    label: usedItems[i].label,
    icon: usedItems[i].icon,
    textColor: usedItems[i].textColor
  }));
}
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor: it.color || '#e5e7eb' // Default gray if no color/image
                    }}
                  >
                    {it.color ? (
                      <div 
