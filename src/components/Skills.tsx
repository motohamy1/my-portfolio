...
const skills = [
  ...
  { label: 'Tailwind CSS', color: '#722F37', textColor: '#ffffff', icon: <Wind className="w-full h-full" /> }, // wine
  { label: 'Git', color: '#EFFBBB', textColor: '#14532d', icon: <GitBranch className="w-full h-full" /> }, // forest
  { label: 'GitHub', color: '#9D1F15', textColor: '#ffffff', icon: <Github className="w-full h-full" /> }, // rust
  ...
  { label: 'Docker', color: '#722F37', textColor: '#ffffff', icon: <Container className="w-full h-full" /> },
  { label: 'AWS', color: '#fbf7ba', textColor: '#854d0e', icon: <Cloud className="w-full h-full" /> },
  { label: 'Figma', color: '#9D1F15', textColor: '#ffffff', icon: <PenTool className="w-full h-full" /> },
  ...
  { label: 'Supabase', color: '#722F37', textColor: '#ffffff', icon: <Database className="w-full h-full" /> },
  { label: 'Firebase', color: '#EFFBBB', textColor: '#000000', icon: <Flame className="w-full h-full" /> },
  { label: 'Jest', color: '#9D1F15', textColor: '#ffffff', icon: <TestTube className="w-full h-full" /> },
  ...
  { label: 'Bun', color: '#722F37', textColor: '#ffffff', icon: <Package className="w-full h-full" /> },
  { label: 'Python', color: '#fbf7ba', textColor: '#1e3a8a', icon: <Code className="w-full h-full" /> },
  { label: 'Django', color: '#9D1F15', textColor: '#ffffff', icon: <Shield className="w-full h-full" /> },
...
const Skills = () => {
  return (
    <div id="skills" style={{ width: '100%', height: '100vh', overflow: 'hidden' }} className=''>
